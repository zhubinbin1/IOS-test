...
//首页数据
#define API_HomePage @"api/live/card_recommend"

//user_feed列表
#define API_UserFeed @"api/user_feed/recommend"//?uid=85149891&latitude=40.090562&longitude=116.413353
//附近的直播
#define API_NearBy @"api/live/card_recommend"
